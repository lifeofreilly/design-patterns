<jsp:useBean id="beatModel" scope="request" class="com.gmail.lifeofreilly.mvcservlet.BeatModel"/>
...
<form method="get" action="/mvcservlet/servlet/BeatControllerServlet">
